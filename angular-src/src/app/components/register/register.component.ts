...
export class RegisterComponent implements OnInit {
  ...
  constructor(private customerValidateService: CustomervalidateService, private flashMessage: FlashMessagesService, private authService: AuthService, private router: Router) { }
