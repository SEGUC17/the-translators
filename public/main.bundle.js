...
var BookingvalidationService = (function () {
    ...
    BookingvalidationService.prototype.validateBooking = function (booking) {
...
var AuthService = (function () {
    ...
    AuthService.prototype.bookingRequest = function (booking) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_customerlogin_customerlogin_component__ = __webpack_require__(514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_businesslogin_businesslogin_component__ = __webpack_require__(512);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_businessprofile_businessprofile_component__ = __webpack_require__(513);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_subscribe_subscribe_component__ = __webpack_require__(520);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_bookingrequest_bookingrequest_component__ = __webpack_require__(511);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_uploadproducts_uploadproducts_component__ = __webpack_require__(521);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_customervalidate_service__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_bookingvalidation_service__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__services_businessvalidate_service__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__services_uploadproductsvalidate_service__ = __webpack_require__(336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__services_auth_service__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22_angular2_flash_messages__ = __webpack_require__(57);
...
var appRoutes = [
    ...
    { path: 'booking', component: __WEBPACK_IMPORTED_MODULE_15__components_bookingrequest_bookingrequest_component__["a" /* BookingrequestComponent */] },
    { path: 'uploadproducts', component: __WEBPACK_IMPORTED_MODULE_16__components_uploadproducts_uploadproducts_component__["a" /* UploadproductsComponent */] }
];
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__components_bookingrequest_bookingrequest_component__["a" /* BookingrequestComponent */],
                __WEBPACK_IMPORTED_MODULE_16__components_uploadproducts_uploadproducts_component__["a" /* UploadproductsComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_17__services_customervalidate_service__["a" /* CustomervalidateService */], __WEBPACK_IMPORTED_MODULE_19__services_businessvalidate_service__["a" /* BusinessvalidateService */], __WEBPACK_IMPORTED_MODULE_21__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_18__services_bookingvalidation_service__["a" /* BookingvalidationService */], __WEBPACK_IMPORTED_MODULE_20__services_uploadproductsvalidate_service__["a" /* UploadproductsvalidateService */]],
...
var BookingrequestComponent = (function () {
    ...
    BookingrequestComponent.prototype.onBookingSubmit = function () {
        var _this = this;
        var booking = {
        ...
        this.authService.bookingRequest(booking).subscribe(function (data) {
            if (data.success) {
                ...
                _this.router.navigate(['/customerlogin']); //right the pathname(get it from app.module.ts) u want him to redirect to after booking is successful
            }
            else {
                _this.flashMessage.show('Something went wrong', { cssClass: 'alert-danger', timeout: 3000 });
                _this.router.navigate(['/register']); //right the pathname(get it from app.module.ts) u want him to redirect to after booking is failed or empty
            }
        });
    };
